...
class Space():
    ...
    def hill_climb(self, maximum=None, image_prefix=None, log=False):
        ...
        # Start by initializing hospitals at random locations
        self.hospitals = set()
        ...
        while maximum is None or count < maximum:
            ...
            for hospital in self.hospitals:
                ...
                # *hospital indicates more than one hospital
    ...
    def random_restart(self, maximum, image_prefix=None, log=False):
        ...
        for i in range(maximum):
            #randomly place a bunch of hospitals
            #and perform hill climbing on each bunch, til you get a good
            #local minimum
            hospitals = self.hill_climb()
            cost = self.get_cost(hospitals)
            #if a better solution was found, update it
    ...
    def get_cost(self, hospitals):
        ...
        for house in self.houses:
            cost += min(
                #gets the minimum distance between all houses and all hosiptals
                #select the small distance from a house to a hospital
...
#hospitals = s.hill_climb(image_prefix=None, log=True)
hospitals = s.random_restart(20, image_prefix=None, log=True)